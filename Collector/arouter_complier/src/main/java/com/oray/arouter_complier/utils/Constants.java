package com.oray.arouter_complier.utils;
...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String AROUTER_ANNOTATION_TYPES = "com.oray.arouter.annotation.ARouter";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.oray.arouter_annotation.Parameter";
