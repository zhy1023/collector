...
import com.zhy.collector.adapter.ViewPagerAdapter;
import com.zhy.collector.utils.UIUtils;
...
public class
BottomNavigationBar extends LinearLayout {
    ...
    private BottomNavigationBar.OnTabClickListener onTabClickListener;
    //消息红点字体大小
    ...
    private float navigationHeight = 50;
    ...
    //Add
    private BottomNavigationBar.OnAddClickListener onAddClickListener;
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        contentView = (RelativeLayout) View.inflate(context, R.layout.bottom_navigation_container, null);
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.BottomNavigationBar);
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
            navigationHeight = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_navigationHeight, navigationHeight);
            navigationBackground = attributes.getColor(R.styleable.BottomNavigationBar_Easy_navigationBackground, navigationBackground);


            tabTextSize = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_tabTextSize, tabTextSize);
            tabTextTop = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_tabTextTop, tabTextTop);
            iconSize = (int) attributes.getDimension(R.styleable.BottomNavigationBar_Easy_tabIconSize, iconSize);
            hintPointSize = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_hintPointSize, hintPointSize);
            msgPointSize = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_msgPointSize, msgPointSize);
            hintPointLeft = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_hintPointLeft, hintPointLeft);
            msgPointTop = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_msgPointTop, -iconSize / 2);
            hintPointTop = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_msgPointLeft, -iconSize / 2);
            msgPointTextSize = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_msgPointTextSize, msgPointTextSize);
            addIconSize = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_addIconSize, addIconSize);
            addLayoutBottom = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_addLayoutBottom, addLayoutBottom);

            //加号属性
            addSelectTextColor = attributes.getColor(R.styleable.BottomNavigationBar_Easy_addSelectTextColor, addSelectTextColor);
            addNormalTextColor = attributes.getColor(R.styleable.BottomNavigationBar_Easy_addNormalTextColor, addNormalTextColor);
            addTextSize = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_addTextSize, addTextSize);
            addTextTopMargin = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_addTextTopMargin, addTextTopMargin);
            addAlignBottom = attributes.getBoolean(R.styleable.BottomNavigationBar_Easy_addAlignBottom, addAlignBottom);


            lineHeight = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_lineHeight, lineHeight);
            lineColor = attributes.getColor(R.styleable.BottomNavigationBar_Easy_lineColor, lineColor);


            addLayoutHeight = attributes.getDimension(R.styleable.BottomNavigationBar_Easy_addLayoutHeight, navigationHeight + lineHeight);

            normalTextColor = attributes.getColor(R.styleable.BottomNavigationBar_Easy_tabNormalColor, normalTextColor);
            selectTextColor = attributes.getColor(R.styleable.BottomNavigationBar_Easy_tabSelectColor, selectTextColor);

            int type = attributes.getInt(R.styleable.BottomNavigationBar_Easy_scaleType, 0);
            if (type == 0) {
            ...
            addLayoutRule = attributes.getInt(R.styleable.BottomNavigationBar_Easy_addLayoutRule, addLayoutRule);
            hasPadding = attributes.getBoolean(R.styleable.BottomNavigationBar_Easy_hasPadding, hasPadding);

            addAsFragment = attributes.getBoolean(R.styleable.BottomNavigationBar_Easy_addAsFragment, addAsFragment);
    ...
    //将dp、sp转换成px
    private void toDp() {
        navigationHeight = UIUtils.dip2px(getContext(), navigationHeight);
        iconSize = UIUtils.dip2px(getContext(), iconSize);
        hintPointSize = UIUtils.dip2px(getContext(), hintPointSize);
        hintPointTop = UIUtils.dip2px(getContext(), hintPointTop);
        hintPointLeft = UIUtils.dip2px(getContext(), hintPointLeft);

        msgPointLeft = UIUtils.dip2px(getContext(), msgPointLeft);
        msgPointTop = UIUtils.dip2px(getContext(), msgPointTop);
        msgPointSize = UIUtils.dip2px(getContext(), msgPointSize);
        msgPointTextSize = UIUtils.sp2px(getContext(), msgPointTextSize);

        tabTextTop = UIUtils.dip2px(getContext(), tabTextTop);
        tabTextSize = UIUtils.sp2px(getContext(), tabTextSize);


        //Add
        addIconSize = UIUtils.dip2px(getContext(), addIconSize);
        addLayoutHeight = UIUtils.dip2px(getContext(), addLayoutHeight);
        addLayoutBottom = UIUtils.dip2px(getContext(), addLayoutBottom);
        addTextSize = UIUtils.sp2px(getContext(), addTextSize);
        addTextTopMargin = UIUtils.dip2px(getContext(), addTextTopMargin);
    }
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    public void buildNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            View itemView = View.inflate(getContext(), R.layout.bottom_navigation_tab, null);
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.MATCH_PARENT);
            params.width = UIUtils.getScreenWidth(getContext()) / tabCount;
            ...
            msgPoint.setTextSize(UIUtils.px2sp(getContext(), msgPointTextSize));
            ...
            text.setTextSize(UIUtils.px2sp(getContext(), tabTextSize));
    ...
    public void buildAddNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (i == tabCount / 2) {
                ...
                addItemParams.width = UIUtils.getScreenWidth(getContext()) / tabCount;
                ...
                addText.setTextSize(UIUtils.px2sp(getContext(), addTextSize));
    ...
    public void buildAddViewNavigation() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (i == tabCount / 2) {
                ...
                final RelativeLayout.LayoutParams linearParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                //linearParams.width = UIUtils.getScreenWidth(getContext()) / tabCount;
    ...
    public BottomNavigationBar addLayoutHeight(int addLayoutHeight) {
        this.addLayoutHeight = UIUtils.dip2px(getContext(), addLayoutHeight);
        return this;
    }
    ...
    public BottomNavigationBar addIconSize(int addIconSize) {
        this.addIconSize = UIUtils.dip2px(getContext(), addIconSize);
        return this;
    }
 ...
 /*   public EasyNavigationBar onAddClickListener(EasyNavigationBar.OnAddClickListener onAddClickListener) {
    ...
    public BottomNavigationBar navigationHeight(int navigationHeight) {
        this.navigationHeight = UIUtils.dip2px(getContext(), navigationHeight);
        return this;
    }
    ...
    public BottomNavigationBar tabTextSize(int tabTextSize) {
        this.tabTextSize = UIUtils.sp2px(getContext(), tabTextSize);
        return this;
    }

    public BottomNavigationBar tabTextTop(int tabTextTop) {
        this.tabTextTop = UIUtils.dip2px(getContext(), tabTextTop);
        return this;
    }

    public BottomNavigationBar msgPointTextSize(int msgPointTextSize) {
        this.msgPointTextSize = UIUtils.sp2px(getContext(), msgPointTextSize);
        return this;
    }

    public BottomNavigationBar msgPointSize(int msgPointSize) {
        this.msgPointSize = UIUtils.dip2px(getContext(), msgPointSize);
        return this;
    }

    public BottomNavigationBar msgPointLeft(int msgPointLeft) {
        this.msgPointLeft = UIUtils.dip2px(getContext(), msgPointLeft);
        return this;
    }

    public BottomNavigationBar msgPointTop(int msgPointTop) {
        this.msgPointTop = UIUtils.dip2px(getContext(), msgPointTop);
        return this;
    }


    public BottomNavigationBar hintPointSize(int hintPointSize) {
        this.hintPointSize = UIUtils.dip2px(getContext(), hintPointSize);
        return this;
    }

    public BottomNavigationBar hintPointLeft(int hintPointLeft) {
        this.hintPointLeft = UIUtils.dip2px(getContext(), hintPointLeft);
        return this;
    }

    public BottomNavigationBar hintPointTop(int hintPointTop) {
        this.hintPointTop = UIUtils.dip2px(getContext(), hintPointTop);
        return this;
    }
 ...
 /*   public EasyNavigationBar anim(Anim anim) {
    ...
    public BottomNavigationBar onTabClickListener(BottomNavigationBar.OnTabClickListener onTabClickListener) {
    ...
    public BottomNavigationBar iconSize(int iconSize) {
        this.iconSize = UIUtils.dip2px(getContext(), iconSize);
        return this;
    }

    public BottomNavigationBar addLayoutBottom(int addLayoutBottom) {
        this.addLayoutBottom = UIUtils.dip2px(getContext(), addLayoutBottom);
        return this;
    }
    ...
    public BottomNavigationBar addTextSize(int addTextSize) {
        this.addTextSize = UIUtils.sp2px(getContext(), addTextSize);
        return this;
    }
    ...
    public BottomNavigationBar addTextTopMargin(int addTextTopMargin) {
        this.addTextTopMargin = UIUtils.dip2px(getContext(), addTextTopMargin);
        return this;
    }
  ...
  /*  public Techniques getAnim() {
    ...
    public BottomNavigationBar.OnTabClickListener getOnTabClickListener() {
    ...
    public BottomNavigationBar.OnAddClickListener getOnAddClickListener() {
